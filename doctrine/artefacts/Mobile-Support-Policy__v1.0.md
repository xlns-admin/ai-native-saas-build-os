...
**Document:** Mobile-Support-Policy__v1.0  
...
**Supersedes:** None  
**Applies to:** All governed product repositories introducing mobile access or native clients  
...
All mobile implementations must comply with the following controls.
...
Failure to update the Threat Model blocks lifecycle progression.
...
**v1.0** — Initial Mobile Support Policy  
Introduces client classification levels, security controls, offline governance, and lifecycle enforcement integration.
